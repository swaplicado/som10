::==============================================================================
:: Script Batch to start and continue at intervals the execution of the process
:: for importing Revuelta tickets into SOM.
:: This script must be executed at the root directory of SOM.
:: Date: 2019-09-20
::==============================================================================
echo off
color 0C
