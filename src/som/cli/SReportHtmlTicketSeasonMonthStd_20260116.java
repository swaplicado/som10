 ...
 */
public class SReportHtmlTicketSeasonMonthStd_20260116 {
    ...
    public SReportHtmlTicketSeasonMonthStd_20260116(final SGuiSession session) {
        moSession = session;
    }
    ...
    public String generateReportHtml(final int[] itemIds, final int yearRef, final int intvlDays, final Date today, final Date cutOff, final int ticOrig, final int ticDest, final int mode) throws Exception {
        ...
        html += "<h2>" + SLibUtils.textToHtml("Histórico mensual báscula recepción fruta") + "</h2>\n";
