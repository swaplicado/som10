 ...
 */
public class SFormInputSource extends sa.lib.gui.bean.SBeanForm {

    private SDbInputSource moRegistry;

    /**
     * Creates new form SFormInputClass
     */
    public SFormInputSource(SGuiClient client, String title) {
        setFormSettings(client, SGuiConsts.BEAN_FORM_EDIT, SModConsts.SU_INP_SRC, SLibConsts.UNDEFINED, title);
        initComponents();
    ...
    public void setRegistry(SDbRegistry registry) throws Exception {
        moRegistry = (SDbInputSource) registry;
    ...
    public SDbRegistry getRegistry() throws Exception {
        SDbInputSource registry = moRegistry.clone();
        ...
        registry.setFkInputCategoryId(moKeyInputCategory.getValue()[0]);
    ...
    public SGuiValidation validateForm() {
        ...
        if (validation.isValid()) {
            if (moKeyInputCategory.getValue()[0] == SModSysConsts.SU_INP_CT_NA) {
                validation.setMessage(SGuiConsts.ERR_MSG_FIELD_DIF + "'" + moKeyInputCategory.getFieldName() + "'.");
