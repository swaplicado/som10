 ...
 */
public class SFormTicketOrigin extends SBeanForm {

    private SDbTicketOrigin moRegistry;

    /**
     * Creates new form SFormTicketOrigin
     * @param client
     * @param title
     */
    public SFormTicketOrigin(SGuiClient client, String title) {
        setFormSettings(client, SGuiConsts.BEAN_FORM_EDIT, SModConsts.SU_TIC_ORIG, SLibConsts.UNDEFINED, title);
        initComponents();
    ...
    public void setRegistry(SDbRegistry registry) throws Exception {
        moRegistry = (SDbTicketOrigin) registry;
    ...
    public SDbRegistry getRegistry() throws Exception {
        SDbTicketOrigin registry = moRegistry.clone();
