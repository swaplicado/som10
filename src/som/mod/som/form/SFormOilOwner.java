 ...
 */
public class SFormOilOwner extends sa.lib.gui.bean.SBeanForm {

    private SDbOilOwner moRegistry;
     ...
     * @param title
     */
    public SFormOilOwner(SGuiClient client, String title) {
    ...
    public void setRegistry(SDbRegistry registry) throws Exception {
        moRegistry = (SDbOilOwner) registry;
    ...
    public SDbRegistry getRegistry() throws Exception {
        SDbOilOwner registry = moRegistry.clone();
