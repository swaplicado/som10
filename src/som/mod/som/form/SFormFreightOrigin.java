 ...
 */
public class SFormFreightOrigin extends SBeanForm {

    private SDbFreightOrigin moRegistry;

    /**
     * Creates new form SFormFreightOrigin
     * @param client
     * @param title
     */
    public SFormFreightOrigin(SGuiClient client, String title) {
        setFormSettings(client, SGuiConsts.BEAN_FORM_EDIT, SModConsts.SU_FREIGHT_ORIG, SLibConsts.UNDEFINED, title);
        initComponents();
    ...
    public void setRegistry(SDbRegistry registry) throws Exception {
        moRegistry = (SDbFreightOrigin) registry;
    ...
    public SDbRegistry getRegistry() throws Exception {
        SDbFreightOrigin registry = moRegistry.clone();
