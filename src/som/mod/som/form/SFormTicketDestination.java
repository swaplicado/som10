 ...
 */
public class SFormTicketDestination extends SBeanForm {

    private SDbTicketDestination moRegistry;

    /**
     * Creates new form SFormTicketDestination
     * @param client
     * @param title
     */
    public SFormTicketDestination(SGuiClient client, String title) {
        setFormSettings(client, SGuiConsts.BEAN_FORM_EDIT, SModConsts.SU_TIC_DEST, SLibConsts.UNDEFINED, title);
        initComponents();
    ...
    public void setRegistry(SDbRegistry registry) throws Exception {
        moRegistry = (SDbTicketDestination) registry;
    ...
    public SDbRegistry getRegistry() throws Exception {
        SDbTicketDestination registry = moRegistry.clone();
