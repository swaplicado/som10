 ...
 */
public class SFormOilClass extends sa.lib.gui.bean.SBeanForm {

    private SDbOilClass moRegistry;
     ...
     * @param title
     */
    public SFormOilClass(SGuiClient client, String title) {
    ...
    public void setRegistry(SDbRegistry registry) throws Exception {
        moRegistry = (SDbOilClass) registry;
    ...
    public SDbRegistry getRegistry() throws Exception {
        SDbOilClass registry = moRegistry.clone();
