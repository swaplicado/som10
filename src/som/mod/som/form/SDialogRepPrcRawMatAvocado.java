 ...
 * 
 */
public class SDialogRepPrcRawMatAvocado extends SBeanDialogReport implements ChangeListener {

    /**
     * Creates new form SDialogRepPrcRarMatAvocado
     * @param client
     * @param title
     */
    public SDialogRepPrcRawMatAvocado(SGuiClient client, String title) {
        setFormSettings(client, SModConsts.SR_PRC_RAW_MAT_AVO, SLibConsts.UNDEFINED, title);
        initComponents();
    ...
    private void initComponents() {
        ...
        jlPeriodType = new javax.swing.JLabel();
        moRadPeriodTypeCal = new sa.lib.gui.bean.SBeanFieldRadio();
        moRadPeriodTypeAvo = new sa.lib.gui.bean.SBeanFieldRadio();
        ...
        jlPeriod.getAccessibleContext().setAccessibleName("Periodo:");
        ...
        jlPeriodType.setText("Tipo de periodo:");
        jlPeriodType.setPreferredSize(new java.awt.Dimension(100, 23));
        jPanel4.add(jlPeriodType);

        bgPeriodType.add(moRadPeriodTypeCal);
        moRadPeriodTypeCal.setText("Mes calendario");
        moRadPeriodTypeCal.setPreferredSize(new java.awt.Dimension(125, 23));
        jPanel4.add(moRadPeriodTypeCal);

        bgPeriodType.add(moRadPeriodTypeAvo);
        moRadPeriodTypeAvo.setText("Mes aguacatero");
        moRadPeriodTypeAvo.setPreferredSize(new java.awt.Dimension(125, 23));
        jPanel4.add(moRadPeriodTypeAvo);
        ...
        jlMonth.getAccessibleContext().setAccessibleName("Mes:");
    ...
    private javax.swing.JLabel jlPeriodType;
    ...
    private sa.lib.gui.bean.SBeanFieldRadio moRadPeriodTypeAvo;
    private sa.lib.gui.bean.SBeanFieldRadio moRadPeriodTypeCal;
    ...
    private void initComponentsCustom() {
        ...
        moRadPeriodTypeCal.setBooleanSettings(moRadPeriodTypeCal.getText(), true);
        moRadPeriodTypeAvo.setBooleanSettings(moRadPeriodTypeAvo.getText(), false);
        ...
        moFields.addField(moRadPeriodTypeCal);
        moFields.addField(moRadPeriodTypeAvo);
        ...
        moRadPeriodTypeCal.setSelected(true);
    ...
    public void createParamsMap() {
        ...
        if (moRadPeriodTypeCal.isSelected()) {
            sqlWhere += "AND YEAR(s.dt) = " + moCalendarYear.getValue() + " ";
            sqlWhere += moRadPeriodByYearMonth.isSelected() ? "AND MONTH(s.dt) = " + moCalendarMonth.getValue() + " " : "";
        }
        else {
            sqlWhere += "AND c.cal_year = " + moCalendarYear.getValue() + " ";
            sqlWhere += moRadPeriodByYearMonth.isSelected() ? "AND c.cal_month = " + moCalendarMonth.getValue() + " " : "";
        }
        ...
        moParamsMap.put("bPeriodCal", moRadPeriodTypeCal.isSelected());
