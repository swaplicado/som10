 ...
 */
public class SFormSupraRegion extends SBeanForm {

    private SDbSupraRegion moRegistry;

    /**
     * Creates new form SFormRegion
     */
    public SFormSupraRegion(SGuiClient client, String title) {
    ...
    public void setRegistry(SDbRegistry registry) throws Exception {
        moRegistry = (SDbSupraRegion) registry;
    ...
    public SDbRegistry getRegistry() throws Exception {
        SDbSupraRegion registry = moRegistry.clone();
