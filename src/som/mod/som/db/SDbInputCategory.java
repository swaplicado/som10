...
public class SDbInputCategory extends SDbRegistryUser {
    ...
    */
    ...
    public SDbInputCategory() {
        super(SModConsts.SU_INP_CT);
        initRegistry();
    }
    ...
    public int[] getPrimaryKey() {
        return new int[] { mnPkInputCategoryId };
    }
    ...
    public String getSqlWhere() {
        return "WHERE id_inp_ct = " + mnPkInputCategoryId + " ";
    }

    @Override
    public String getSqlWhere(int[] pk) {
        return "WHERE id_inp_ct = " + pk[0] + " ";
    }
    ...
    public void computePrimaryKey(SGuiSession session) throws SQLException, Exception {
        ...
        msSql = "SELECT COALESCE(MAX(id_inp_ct), 0) + 1 FROM " + getSqlTable() + " ";
        resultSet = session.getStatement().executeQuery(msSql);
        if (resultSet.next()) {
            mnPkInputCategoryId = resultSet.getInt(1);
        }
    }
    ...
    @Override
    public SDbInputCategory clone() throws CloneNotSupportedException {
        SDbInputCategory registry = new SDbInputCategory();
