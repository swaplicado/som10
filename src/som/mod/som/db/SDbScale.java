 ...
 */
public class SDbScale extends SDbRegistryUser {
    ...
    */
    ...
    public String getSqlWhere() {
        return "WHERE id_sca = " + mnPkScaleId + " ";
    }

    @Override
    public String getSqlWhere(int[] pk) {
        return "WHERE id_sca = " + pk[0] + " ";
    }
    ...
    public void computePrimaryKey(SGuiSession session) throws SQLException, Exception {
        ...
        msSql = "SELECT COALESCE(MAX(id_sca), 0) + 1 FROM " + getSqlTable() + " ";
        resultSet = session.getStatement().executeQuery(msSql);
        if (resultSet.next()) {
            mnPkScaleId = resultSet.getInt(1);
        }
    }
    ...
    @Override
    public SDbScale clone() throws CloneNotSupportedException {
        SDbScale registry = new SDbScale();
