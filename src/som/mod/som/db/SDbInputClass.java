 ...
 */
public class SDbInputClass extends SDbRegistryUser {
    ...
    */
    ...
    public SDbInputClass() {
        super(SModConsts.SU_INP_CL);
        initRegistry();
    }
    ...
    public int[] getPrimaryKey() {
        return new int[] { mnPkInputCategoryId, mnPkInputClassId };
    }
    ...
    public void computePrimaryKey(SGuiSession session) throws SQLException, Exception {
        ...
        msSql = "SELECT COALESCE(MAX(id_inp_cl), 0) + 1 FROM " + getSqlTable() + " "
                + "WHERE id_inp_ct = " + mnPkInputCategoryId + " ";
        resultSet = session.getStatement().executeQuery(msSql);
        if (resultSet.next()) {
            mnPkInputClassId = resultSet.getInt(1);
        }
    }
    ...
    @Override
    public SDbInputClass clone() throws CloneNotSupportedException {
        SDbInputClass registry = new SDbInputClass();
