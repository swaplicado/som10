 ...
 */
public class SViewOilType extends SGridPaneView {

    public SViewOilType(SGuiClient client, String title) {
        super(client, SGridConsts.GRID_PANE_VIEW, SModConsts.SU_OIL_TP, SLibConsts.UNDEFINED, title);
    }
    ...
    public void prepareSqlQuery() {
        ...
        msSql = "SELECT "
                ...
                + "v.id_oil_tp AS " + SDbConsts.FIELD_ID + "2, "
                ...
                + "FROM " + SModConsts.TablesMap.get(SModConsts.SU_OIL_TP) + " AS v "
                + "INNER JOIN " + SModConsts.TablesMap.get(SModConsts.SU_OIL_CL) + " AS cl ON "
                + "v.id_oil_cl = cl.id_oil_cl "
                + "INNER JOIN " + SModConsts.TablesMap.get(SModConsts.CU_USR) + " AS ui ON "
                + "v.fk_usr_ins = ui.id_usr "
                + "INNER JOIN " + SModConsts.TablesMap.get(SModConsts.CU_USR) + " AS uu ON "
                + "v.fk_usr_upd = uu.id_usr "
                + (sql.isEmpty() ? "" : "WHERE " + sql)
                + "ORDER BY v.name, v.id_oil_cl, v.id_oil_tp ";
    }
    ...
    public void createGridColumns() {
        ...
        columns[col++] = new SGridColumnView(SGridConsts.COL_TYPE_TEXT_NAME_CAT_M, "cl.name", "Clase aceite");
    ...
    public void defineSuscriptions() {
        ...
        moSuscriptionsSet.add(SModConsts.SU_OIL_CL);
