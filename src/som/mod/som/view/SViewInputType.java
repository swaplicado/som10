 ...
 */
public class SViewInputType extends SGridPaneView {

    public SViewInputType(SGuiClient client, String title) {
        super(client, SGridConsts.GRID_PANE_VIEW, SModConsts.SU_INP_TP, SLibConsts.UNDEFINED, title);
    }
    ...
    public void prepareSqlQuery() {
        ...
        msSql = "SELECT "
                ...
                + "v.id_inp_cl AS " + SDbConsts.FIELD_ID + "2, "
                + "v.id_inp_tp AS " + SDbConsts.FIELD_ID + "3, "
                ...
                + "FROM " + SModConsts.TablesMap.get(SModConsts.SU_INP_TP) + " AS v "
                + "INNER JOIN " + SModConsts.TablesMap.get(SModConsts.SU_INP_CL) + " AS icl ON "
                + "v.id_inp_ct = icl.id_inp_ct AND v.id_inp_cl = icl.id_inp_cl "
                + "INNER JOIN " + SModConsts.TablesMap.get(SModConsts.SU_INP_CT) + " AS ict ON "
                + "v.id_inp_ct = ict.id_inp_ct "
                + "INNER JOIN " + SModConsts.TablesMap.get(SModConsts.CU_USR) + " AS ui ON "
                + "v.fk_usr_ins = ui.id_usr "
                + "INNER JOIN " + SModConsts.TablesMap.get(SModConsts.CU_USR) + " AS uu ON "
                + "v.fk_usr_upd = uu.id_usr "
                + (sql.isEmpty() ? "" : "WHERE " + sql)
                + "ORDER BY v.name, v.id_inp_ct, v.id_inp_cl, v.id_inp_tp ";
    }
    ...
    public void createGridColumns() {
        ...
        columns[col++] = new SGridColumnView(SGridConsts.COL_TYPE_TEXT_NAME_CAT_S, "icl.name", "Clase insumo");
