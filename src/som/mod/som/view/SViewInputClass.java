 ...
 */
public class SViewInputClass extends SGridPaneView {

    public SViewInputClass(SGuiClient client, String title) {
        super(client, SGridConsts.GRID_PANE_VIEW, SModConsts.SU_INP_CL, SLibConsts.UNDEFINED, title);
    }
    ...
    public void prepareSqlQuery() {
        ...
        msSql = "SELECT "
                ...
                + "FROM " + SModConsts.TablesMap.get(SModConsts.SU_INP_CL) + " AS v "
                ...
                + "ORDER BY v.name, v.id_inp_ct, v.id_inp_cl ";
    }
