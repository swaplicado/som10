 ...
 * @author Juan Barajas
 */
public class SViewIodineValueRank extends SGridPaneView {

    public SViewIodineValueRank(SGuiClient client, String title) {
        super(client, SGridConsts.GRID_PANE_VIEW, SModConsts.SU_IOD_VAL_RANK, SLibConsts.UNDEFINED, title);
    }
    ...
    public void prepareSqlQuery() {
        ...
        msSql = "SELECT "
                ...
                + "v.id_rank AS " + SDbConsts.FIELD_ID + "2, "
                ...
                + "FROM " + SModConsts.TablesMap.get(SModConsts.SU_IOD_VAL_RANK) + " AS v "
                + "INNER JOIN " + SModConsts.TablesMap.get(SModConsts.SU_ITEM) + " AS it ON "
                + "v.id_item = it.id_item "
                + "INNER JOIN " + SModConsts.TablesMap.get(SModConsts.CU_USR) + " AS ui ON "
                + "v.fk_usr_ins = ui.id_usr "
                + "INNER JOIN " + SModConsts.TablesMap.get(SModConsts.CU_USR) + " AS uu ON "
                + "v.fk_usr_upd = uu.id_usr "
                + (sql.isEmpty() ? "" : "WHERE " + sql)
                + "ORDER BY v.lim_low_n, v.lim_top_n, v.id_item, v.id_rank ";
    }
    ...
    public void createGridColumns() {
        ...
        columns[col++] = new SGridColumnView(SGridConsts.COL_TYPE_DEC_4D, "v.lim_low_n", "Rango inferior");
        columns[col++] = new SGridColumnView(SGridConsts.COL_TYPE_DEC_4D, "v.lim_top_n", "Rango superior");
