 ...
 */
public class SViewInputSource extends SGridPaneView {

    public SViewInputSource(SGuiClient client, String title) {
        super(client, SGridConsts.GRID_PANE_VIEW, SModConsts.SU_INP_SRC, SLibConsts.UNDEFINED, title);
    }
    ...
    public void prepareSqlQuery() {
        ...
        msSql = "SELECT "
                + "v.id_inp_src AS " + SDbConsts.FIELD_ID + "1, "
                ...
                + "FROM " + SModConsts.TablesMap.get(SModConsts.SU_INP_SRC) + " AS v "
                ...
                + "ORDER BY ict.name, ict.id_inp_ct, v.name, v.id_inp_src ";
    }
