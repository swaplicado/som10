 ...
 */
public class SDbTicketStatus extends SDbRegistryUser {
    ...
    */
    ...
    public SDbTicketStatus() {
        super(SModConsts.M_TIC_ST);
    }
    ...
    public void read(SGuiSession session, int[] pk) throws SQLException, Exception {
        ...
        if (!resultSet.next()) {
            ...
            mnFkTicketStatusId = resultSet.getInt("fk_tic_st");
    ...
    @Override
    public SDbTicketStatus clone() throws CloneNotSupportedException {
        SDbTicketStatus registry = new SDbTicketStatus();
