 ...
 */
public class SViewReportingGroup extends SGridPaneView {

    public SViewReportingGroup(SGuiClient client, String title) {
        super(client, SGridConsts.GRID_PANE_VIEW, SModConsts.CU_REP_GRP, SLibConsts.UNDEFINED, title);
        setRowButtonsEnabled(true, true, true, true, true);
    }
    ...
    public void prepareSqlQuery() {
        ...
        msSql = "SELECT "
                + "v.id_rep_grp AS " + SDbConsts.FIELD_ID + "1, "
                ...
                + "FROM " + SModConsts.TablesMap.get(SModConsts.CU_REP_GRP) + " AS v "
                + "INNER JOIN " + SModConsts.TablesMap.get(SModConsts.CU_USR) + " AS ui ON "
                + "v.fk_usr_ins = ui.id_usr "
                + "INNER JOIN " + SModConsts.TablesMap.get(SModConsts.CU_USR) + " AS uu ON "
                + "v.fk_usr_upd = uu.id_usr "
                + (sql.isEmpty() ? "" : "WHERE " + sql)
                + "ORDER BY v.name, v.sort, v.id_rep_grp ";
    }
