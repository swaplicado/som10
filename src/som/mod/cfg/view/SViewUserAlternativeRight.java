 ...
 */
public class SViewUserAlternativeRight extends SGridPaneView {

    public SViewUserAlternativeRight(SGuiClient client, String title) {
        super(client, SGridConsts.GRID_PANE_VIEW, SModConsts.CS_ALT_RIG, SLibConsts.UNDEFINED, title);
    ...
    public void prepareSqlQuery() {
        ...
        msSql = "SELECT "
                ...
                + "INNER JOIN " + SModConsts.TablesMap.get(SModConsts.CU_USR_ALT_RIG) + " AS ur ON "
                + "v.id_usr = ur.id_usr "
                + "INNER JOIN " + SModConsts.TablesMap.get(SModConsts.CS_ALT_RIG) + " AS r ON "
                + "ur.id_rig = r.id_alt_rig "
                + (sql.isEmpty() ? "" : "WHERE " + sql)
                + "ORDER BY v.name, v.id_usr, r.name, r.id_alt_rig ";
    }
