 ...
 */
public class SViewCompanyBranch extends SGridPaneView {

    public SViewCompanyBranch(SGuiClient client, String title) {
        super(client, SGridConsts.GRID_PANE_VIEW, SModConsts.CU_COB, SLibConsts.UNDEFINED, title);
    ...
    public void prepareSqlQuery() {
        ...
        msSql = "SELECT "
                ...
                + "FROM " + SModConsts.TablesMap.get(SModConsts.CU_COB) + " AS v "
                ...
                + "ORDER BY v.name, v.id_co, v.id_cob ";
    }
