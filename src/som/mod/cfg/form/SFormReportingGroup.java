 ...
 */
public class SFormReportingGroup extends SBeanForm {

    private SDbReportingGroup moRegistry;

    /**
     * Creates new form SFormReportingGroup
     */
    public SFormReportingGroup(SGuiClient client, String title) {
        setFormSettings(client, SGuiConsts.BEAN_FORM_EDIT, SModConsts.CU_REP_GRP, SLibConsts.UNDEFINED, title);
        initComponents();
    ...
    public void setRegistry(SDbRegistry registry) throws Exception {
        moRegistry = (SDbReportingGroup) registry;
    ...
    public SDbRegistry getRegistry() throws Exception {
        SDbReportingGroup registry = moRegistry.clone();
